...
if ( ! function_exists( 'framework_content_nav' ) ) :
/**
 * Display navigation to next/previous pages when applicable.
 */
function framework_content_nav( $nav_id ) {
		...
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			<footer class="comment-meta">
				...
				<div class="comment-metadata">
					...
					<?php edit_comment_link( __( 'Edit', 'framework' ), '<span class="edit-link">', '</span>' ); ?>
...
endif; // ends check for framework_comment()
